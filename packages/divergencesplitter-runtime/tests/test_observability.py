...
class TestConditionObservations:
    ...
    def test_short_circuited_child_is_skipped_without_current_score(self) -> None:
        ...
        diagnostics.instance_evaluated(0, context, MonotonicTime(150), 0, 0)
...
class TestMultiScenarioObservations:
    ...
    def test_updating_one_scenario_keeps_the_other_latest_observation(self) -> None:
        ...
        diagnostics.instance_evaluated(1, context, MonotonicTime(160), 0, 0)
    ...
    def test_scenario_becoming_inactive_leaves_other_scenarios_untouched(self) -> None:
        ...
        diagnostics.instance_evaluated(0, make_context(), MonotonicTime(170), 0, 0)
